...
class PlayState extends MusicBeatState
{
	...
	var cameramovingoffset:Float = 20;
	...
	function goodNoteHit(note:Note):Void
	{
		if (!note.wasGoodHit)
		{
			...
			if (SONG.cameraMoveOnNotes) {
				...
				switch(Std.int(Math.abs(note.noteData)))
				{
				// You can Edit offset or the Keys (Remember I Use Extra Keys Just Make it To Your Game Keys Nember is 7 dad Keys is end at 3 And Bf End at 7)
				//BF
				case 11:
				camFollow.set(boyfriend.getMidpoint().x + 150, boyfriend.getMidpoint().y - 100);
				camFollow.x += boyfriend.cameraPosition[0] + cameramovingoffset; camFollow.y += boyfriend.cameraPosition[1];
